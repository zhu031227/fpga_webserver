...
jwrite 0x5000 0
puts "HW表 idx1: MAC_H=[format 0x%08x [jread 0x5006]] MAC_L=[format 0x%08x [jread 0x5007]] VALID=[format 0x%08x [jread 0x5008]]"
puts "wl_ctrl(0x300)=[format 0x%08x [jread 0x300]]"
