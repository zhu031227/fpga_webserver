...
create_generated_clock -name mdio_clk -source [get_ports clk_50m_in] -divide_by 50 [get_pins "webserver_wrapper:u_webserver|lcpu_mdio:u_lcpu_mdio_eth0|clock_frequency_divider:u_clock_frequency_divider|clk_out"]
